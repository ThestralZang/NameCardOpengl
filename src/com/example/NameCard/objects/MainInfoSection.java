 ...
 */
public class MainInfoSection extends CardSection{


    private final static float[] VERTEX_DATA = {
            //X,Y,Z,S,T
            -0.1f, 0.02f, -0.45f, 0f, 0f,
            -0.1f, 0.02f, 0.25f, 0f, 1f,
            0.8f, 0.02f, -0.45f, 0.642857f, 0f,
            0.8f, 0.02f, 0.25f, 0.642857f, 1f,
    };

    private final VertexArray vertexArray;

    public MainInfoSection() {
