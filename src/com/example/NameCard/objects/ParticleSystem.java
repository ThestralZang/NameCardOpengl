...
import com.example.NameCard.programs.ParticleShaderProgram;
...
public class ParticleSystem {
    ...
    public void addParticle(Geometry.Point position, int color, Geometry.Vector direction,
        ...
        //System.out.println("add a new snow flower in particle system");
        //System.out.print(particles[20]);
        //System.out.print("a new particle: "+position.x+" "+position.y+" "+position.z+" "+direction.x+" "+direction.z+" "+direction.z);
    ...
    public void draw() {
        ...
        //System.out.println("particle system draws "+currentParticleCount +"particles");
    }
}
