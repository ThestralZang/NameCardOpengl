...
import com.example.NameCard.data.IndexBuffer;
import com.example.NameCard.data.VertexBuffer;
import com.example.NameCard.programs.HeightmapShaderProgram;
...
public class Heightmap {
    ...
    public Heightmap(Context context) {
    	...
    	Bitmap bitmap = ((BitmapDrawable)context.getResources()
                .getDrawable(R.drawable.heightmap_1)).getBitmap();
	...
	public void initHeightmapProgram() {
